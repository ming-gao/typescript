...
_any = 12;
_any = '1233';
let _unknown; //未知类型，自身可以是任何变量类型，但是不能赋值给其他指定类型的变量，是一个类型安全的any
_unknown = 'hello';
// 类型断言，可以告知解析器变量的类型
/*
    as 类型
...
let _object; //表示一个object对象
let obj; //{}里指定可以包含哪些属性，？表示可选
...
//     alert('123')
// })  //报错
doc === null || doc === void 0 ? void 0 : doc.addEventListener('click', () => {
    alert('123');
});
